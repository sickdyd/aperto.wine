# Demo accounts and sample catalogue. Safe to re-run: every record is
# created with find_or_create_by!. Loaded automatically by db/seeds.rb in
# development, and manually elsewhere:
#
#   bin/rails runner 'load Rails.root.join("db/seeds/demo.rb")'

raise "Refusing to seed demo accounts in production" if Rails.env.production? && ENV["SHOW_DEV_LOGIN"] != "1"
